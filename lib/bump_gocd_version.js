...
const branchName = `bump-gocd-version-to-${NEXT_GOCD_VERSION}`;
...
const requestConfig = {
    ...
    body: {
        ...
        body: `@gocd/committers Please merge this PR after the release is done. It updates the various GoCD versions.`
    },
    json: true,
    headers: {
